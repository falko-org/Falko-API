Rails.application.routes.draw do
  ...
  get    "/features/:feature_id/sprints/:sprint_id/stories", to: "stories#index", as: "feature_sprint_stories"
  post   "/features/:feature_id/sprints/:sprint_id/stories", to: "stories#create"
  get    "/stories/:id", to: "stories#show", as: "stories"
